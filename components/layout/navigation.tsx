          ...
          <div className="flex h-20 items-center justify-between">
            ...
            <div className="hidden items-center space-x-1 md:flex">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="relative px-3 py-2 text-body-sm font-medium text-navy transition-colors hover:text-navy/70 dark:text-navy-200 dark:hover:text-white rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold-400 focus-visible:ring-offset-2"
                >
                  {link.label}
              ...
              >
                <button
                  className="flex items-center gap-1 px-3 py-2 text-body-sm font-medium text-navy transition-colors hover:text-navy/70 dark:text-navy-200 dark:hover:text-white rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold-400 focus-visible:ring-offset-2"
            ...
            <div className="hidden items-center space-x-3 md:flex">
              ...
              <Link href="/auth/login">
                <Button
                  variant="ghost"
                  className="text-navy hover:bg-navy/10 dark:text-navy-200"
                >
                  Login
                </Button>
              </Link>
            ...
            >
              {isMenuOpen ? (
                ...
                <Menu
                  className={`h-6 w-6 ${
                    isScrolled ? 'text-navy dark:text-white' : 'text-navy dark:text-white'
                  }`}
                />
              )}
            </button>
