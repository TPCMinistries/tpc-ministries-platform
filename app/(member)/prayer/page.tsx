    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
      <Card className="max-w-lg w-full bg-white dark:bg-gray-800 shadow-xl border-0">
        <CardContent className="p-8 text-center">
          <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-pink-500 to-rose-500 rounded-full flex items-center justify-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Our Prayer Wall and prayer features are now part of <strong className="text-gold">Streams of Grace</strong>,
          ...
          <div className="bg-navy/5 dark:bg-navy/20 rounded-xl p-4 mb-6">
            ...
            <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
              <li>• Interactive Prayer Wall</li>
              <li>• Breath Prayer exercises</li>
