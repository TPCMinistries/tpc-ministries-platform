...
import { Sun, ExternalLink, Sparkles } from 'lucide-react'
import Link from 'next/link'

export default function DailyCheckinRedirectPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
      <Card className="max-w-lg w-full bg-white dark:bg-gray-800 shadow-xl border-0">
        <CardContent className="p-8 text-center">
          <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-tpc-gold to-amber-500 rounded-full flex items-center justify-center">
            <Sun className="h-10 w-10 text-white" />
          </div>

          <h1 className="text-2xl font-bold text-navy dark:text-white mb-3">
            Daily Check-in Has Moved!
          </h1>

          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Daily spiritual check-ins are now part of <strong className="text-gold">Streams of Grace</strong>,
          ...
          <div className="bg-navy/5 dark:bg-navy/20 rounded-xl p-4 mb-6">
            ...
            <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
              <li>• Daily spiritual check-in</li>
              <li>• Mood & gratitude tracking</li>
              <li>• Streak building</li>
              <li>• Spiritual garden growth</li>
            </ul>
          </div>
