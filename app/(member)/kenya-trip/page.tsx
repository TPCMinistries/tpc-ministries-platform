...
export default function KenyaTripPage() {
  ...
  const fetchData = async () => {
    ...
    if (tripData) {
      ...
      // Pre-fill application form with member data
      if (memberData) {
  ...
  const serviceTracks = [
    ...
    { value: 'construction', label: 'Construction Team' },
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Choose your area of ministry</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-2 gap-3">
                    {serviceTracks.map(track => (
                      <div key={track.value} className="flex items-center gap-2 p-3 bg-gray-50 rounded-lg">
              ...
              {todaysFocus && (
                <Card className="md:col-span-2 border-gold bg-gradient-to-br from-gold/5 to-transparent">
                  <CardHeader>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-6">
                    ...
                    {/* Service Track */}
                    <div>
                      <h3 className="font-semibold text-navy mb-3">Ministry Interest</h3>
                      <div>
                        <Label>Preferred Service Track</Label>
                        <select
                          value={applicationForm.service_track}
                          onChange={(e) => setApplicationForm({ ...applicationForm, service_track: e.target.value })}
                    ...
                    <Button
                      ...
                      onClick={handleApply}
                      disabled={applying || !applicationForm.first_name || !applicationForm.last_name || !applicationForm.email}
                    >
                      {applying ? (
                        <>
