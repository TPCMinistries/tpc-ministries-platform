...
export const categories: SupplyCategory[] = [
  ...
  },
  {
    ...
    desc: 'Frontline care supplies',
    icon: '🩺',
    colorClass: 'medical',
    items: [
      { name: 'First Aid Kits', qty: 'Need 20', value: '$18 ea', fundAmount: 18, sourcing: 'us' },
      { name: 'OTC Pain Relievers', qty: 'Need 50 bottles', value: '$6 ea', fundAmount: 6, sourcing: 'us' },
      { name: 'Bandages & Gauze', qty: 'Need 100 packs', value: '$3 ea', fundAmount: 3, sourcing: 'us' },
      { name: 'Antiseptic Wipes', qty: 'Need 50 packs', value: '$4 ea', fundAmount: 4, sourcing: 'us' },
      { name: 'Reading Glasses (assorted)', qty: 'Need 50', value: '$4 ea', fundAmount: 4, sourcing: 'kenya' },
      { name: 'Thermometers', qty: 'Need 15', value: '$6 ea', fundAmount: 6, sourcing: 'us' },
    ],
  },
  {
    id: 'general',
